...
const uint16_t highscore_color = RGB(150,150,0);
const int score_y = 4;
const int score_h = 4;
...
const uint16_t palette[]={0,0,RGB(255,255,0),RGB(255,255,255)}; // 3 non transp colors
...
{
	return randint(VGA_H_PIXELS/4,VGA_H_PIXELS*3/4);	
}

static inline int randcolor() {
...
void graph_line()
{
	...
	for (int i=0;i<VGA_H_PIXELS;i++) draw_buffer[i] = BGCOLOR + (vga_line/32)*0b10000100000;
